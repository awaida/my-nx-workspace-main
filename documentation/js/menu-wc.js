                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/DataAccess.html" data-type="entity-link" >DataAccess</a>
                            </li>
                            <li class="link">
                                <a href="components/FeatureAuth.html" data-type="entity-link" >FeatureAuth</a>
                            </li>
                            <li class="link">
                                <a href="components/FeatureOrders.html" data-type="entity-link" >FeatureOrders</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/OrderAddComponent.html" data-type="entity-link" >OrderAddComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/OrderEditComponent.html" data-type="entity-link" >OrderEditComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/SharedUi.html" data-type="entity-link" >SharedUi</a>
                            </li>
                            <li class="link">
